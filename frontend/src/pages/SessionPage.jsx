...
function SessionPage() {
  ...
  const joinSessionMuatation = useJoinSession();
  ...
  // auto-join session if user is not already a particiapnt and not the host
  useEffect(() => {
    if (!session || !user || loadingSession) return;
    if (isHost || isParticipant) return;

    joinSessionMuatation.mutate(id, { onSuccess: refetch });
